    ...
    <header className="border-b border-slate-300 dark:border-slate-700 bg-slate-200 dark:bg-slate-900 transition-colors duration-300">
      <div className="container mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <nav className="flex items-center gap-4">
          <Link to="/about" className={`px-3 py-2 rounded transition-colors ${pathname === "/about" ? "bg-slate-400 dark:bg-slate-700" : "hover:bg-slate-300 dark:hover:bg-slate-800"}`}>
            Proje Hakkında
          </Link>
          <Link to="/" className={`px-3 py-2 rounded transition-colors ${pathname === "/" ? "bg-slate-400 dark:bg-slate-700" : "hover:bg-slate-300 dark:hover:bg-slate-800"}`}>
            Sohbet
          </Link>
